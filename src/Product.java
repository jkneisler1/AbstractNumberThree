...
/**
 * For version 3 of this application, I decided to make getFormattedPrice method abstract.  This method
 * will be implemented in both the Book and Software classes.  Each of these classes will contain a tax which will
 * be different for both the Book and Software classes.
 */
